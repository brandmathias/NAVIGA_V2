    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Pesan suara untuk <strong>{customerName}</strong> telah dibuat. {onConfirm ? 'Unduh file audio atau buka WhatsApp untuk mengirimnya.' : 'Putar atau unduh file audio untuk digunakan sesuai kebutuhan.'}
          </DialogDescription>
        </DialogHeader>
        <div className="my-4">
